...
namespace System.Diagnostics
{
    ...
    public readonly struct ActivityLink  : IEquatable<ActivityLink>
    {
        ...
        public ActivityLink(ActivityContext context, IReadOnlyDictionary<string, object>? attributes)
        {
            Context = context;
        ...
        public bool Equals(ActivityLink link) => Context == link.Context && link.Attributes == Attributes;
        public static bool operator ==(ActivityLink link1, ActivityLink link2) => link1.Equals(link2);
        public static bool operator !=(ActivityLink link1, ActivityLink link2) => !link1.Equals(link2);
