...
namespace System.Diagnostics
{
    ...
    {
        private static readonly IReadOnlyDictionary<string, object> s_emptyAttributes = new Dictionary<string, object>(new Dictionary<string, object>());
        ...
        /// <summary>
        /// Gets the <see cref="IReadOnlyDictionary{String, Object}"/> collection of attributes associated with the event.
        /// </summary>
